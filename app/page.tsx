...
const projectDetails: Record<string, { services: string[]; paragraphs: string[] }> = {
  ...
  daartemis: {
    ...
    paragraphs: [
      "daartemis 是一个以雕塑艺术为灵感的首饰品牌，围绕艺术、珍贵、时尚与独特构建品牌视觉语言。",
      "我通过包装、展览、海报与数字内容的系统化设计，将品牌视觉延展至不同传播场景，保持统一识别的同时强化其独特的艺术气质。",
    ],
  },
  habc: {
  ...
  hnh: {
    services: ["四合扣图案设计"],
    paragraphs: [
      "HNH 四合扣以简洁的字母符号为核心，将品牌识别融入金属扣面，在有限尺度中建立清晰而精致的视觉记忆。",
      "我通过字母结构、线条比例与金属质感的细节控制，使辅料在服装应用中保持克制、耐看且具有辨识度。",
    ],
  },
};
